document.addEventListener("DOMContentLoaded", () => {
    ...
    const historique = JSON.parse(localStorage.getItem("celestedle_history")) || [];
    ...
    if (form) {
        form.addEventListener("submit", (e) => {
            ...
            fetch("http://localhost:3000/api/valider", {
                method: "POST",
...
window.forceReset = function() {
    ...
    fetch("http://localhost:3000/api/admin/verifier-key", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
window.setSecret = function(nomElement) {
    ...
    fetch("http://localhost:3000/api/admin/set-secret", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
